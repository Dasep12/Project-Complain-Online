        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight-bold text-primary">Team IT PT.DI</h5>
     ...
     <script >
            function kosong(){
                swal({
                    ...
                    window.location.href="it_online.php";
                  });
            }
            function kosong1(){
                swal({
                ...
                include 'koneksi.php';
                  if (isset($_POST['cari'])) {
                    ...
                    $row = "SELECT * FROM admin_it where username='$key' AND level='$level' AND status='online' ";
                   ...
                   <?php}elseif($count<=0){ ?>
                      ...
                      <div class="text-center">
                        ...
                        <a href="it_online.php">&larr; Reset Searching</a>
                      </div>
               <?php   }else{ ?>
            ...
            <?php   }
                    ...
                    $row = "SELECT * FROM admin_it where level='$level' AND status='online' ";
                    $data = $koneksi->query($row);
                ...
                while ($r = mysqli_fetch_array($data)) { ?>
                 ...
                 <?php }elseif (empty($r['poto']) AND $r['gender']== $pria) {
                  ...
                  <div class="dropdown mb-4">
                    <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <img src="img/on.png" width="20" height="20"> <?=$r['username'] ?>
                    </button>
                    <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                    <div >
                    <a class="dropdown-item" href="#">Nama Lengkap  <label><?= $r['nama']?></label></a>
                      <a class="dropdown-item" href="#">Sekolah Asal <label><?= $r['sekolah']?></label></a>
                      <a class="dropdown-item" href="#">Jurusan <label><?= $r['jurusan']?></label></a>
                      <a class="dropdown-item" href="#">Alamat Sekolah <label><?= $r['alamat']?></label>
                       </a>
                      <a class="dropdown-item" href="#">Join on <label> <?= $r['bergabung']?></label></a>
                    </div>
                    </div>
