...
<img src="img/img.png" width="400" height="250">
</div>
</div>
</div>
    <!-- Outer Row -->
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="" method="POST" class="user">
                    ...
                    <input  name="kirim" type="submit" name="masuk"  class="btn btn-primary btn-user btn-block" value="Login">
